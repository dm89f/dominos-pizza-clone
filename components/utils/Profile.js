...
function Profile({active}) {
  ...
  return (
    <div className={`transition ${active?"opacity-100":'opacity-0 hidden'} absolute z-50  top-14 right-1 lg:right-8 lg:top-10 w-96  bg-white text-black `}>
      ...
      <p className='px-5 py-3 flex items-center space-x-10 opacity-100  hover:bg-gray-200  shadow-sm'> 
        <AiFillHeart color='rgb(0, 102, 167)' size={25}/> <span className='text-md'>My Favorite</span>
      </p>
      <p className='px-5 py-3 flex items-center space-x-10 opacity-100  hover:bg-gray-200  shadow-sm'> 
